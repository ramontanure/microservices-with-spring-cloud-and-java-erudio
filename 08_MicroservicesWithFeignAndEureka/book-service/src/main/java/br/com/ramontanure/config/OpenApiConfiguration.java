...
public class OpenApiConfiguration {
    ...
    public OpenAPI cusOpenAPI() {
        return new OpenAPI()
                ...
                .info(new io.swagger.v3.oas.models.info.Info().title("Book Microservice API").version("v1").license(new License().name("Apache 2.0").url("https://pub.erudio.com.br/meus-cursos"))                );
    }
}
